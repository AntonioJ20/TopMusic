...
public class TopMusic {
	...
	StringBuilder mostrarLista() {
		...
		int i = 0;
		if (lista.isEmpty())
			cadena.append("\nLa lista estÃƒÂ¡ vacia. Por favor introduzca alguna canciÃƒÂ³n");
	...
	String eliminarCancion(int posicion) {
		if (lista.isEmpty() || posicion - 1 < 0 || posicion > lista.size())
			return "\nERROR al eliminar una canciÃ³n";

		return "\nSe ha borrado la canciÃ³n: " + lista.remove(posicion - 1);
